...
function todo() {
	...
	const createNewTodo = (title) => {
		const todo = new _classes_task__WEBPACK_IMPORTED_MODULE_0__["default"](title);
		if (activeProject) {
	...
	const createNewProject = (title) => {
		const project = new _classes_project__WEBPACK_IMPORTED_MODULE_1__["default"](title);
		saveProject(project);
		return project;
	};
...
//# sourceMappingURL=index3790ef959f9b1ea73077.bundle.js.map